function EEG_out = step1_preprocess_data(EEG_in, low_cutoff, high_cutoff, downsample_rate, frontal_chans, ref_chans, visualize, subject_id)
    ...
    if visualize
        viz_path = sprintf('diagnostics/viz/%s_01_raw_after_chansel.png', subject_id);
    ...
    if visualize
        viz_path = sprintf('diagnostics/viz/%s_03_after_reref.png', subject_id);
    ...
    if visualize
        viz_path = sprintf('diagnostics/viz/%s_04_after_blink_removal.png', subject_id);
