...
def plot_eeg_comparison(fold_num=3, save_plots=True):
    ...
    # Load fold data
    try:
        fold_data = load_matlab_v73(f'python_data_77/fold_{fold_num}_data.mat')
...
def plot_average_across_folds(data_dir='python_data_77', save_plots=True):
    """
...
def main():
    ...
    if not os.path.exists(data_dir):
        data_dir = 'diagnostics/python_data'
        if not os.path.exists(data_dir):
