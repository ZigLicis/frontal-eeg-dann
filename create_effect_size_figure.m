...
%              (e.g., 'python_data' or 'diagnostics/python_data_The_OG')
%              If not provided, loads from 'diagnostics/subject_analysis.mat'
%
% Outputs:
%   - diagnostics/analysis/effect_size_vs_accuracy.png
%   - diagnostics/analysis/effect_size_vs_accuracy.pdf (vector)
%   - diagnostics/analysis/effect_size_vs_accuracy_combined.png
%
% Usage:
...
% Save
saveas(fig1, 'diagnostics/analysis/effect_size_vs_accuracy.png');
try
    saveas(fig1, 'diagnostics/analysis/effect_size_vs_accuracy.pdf');
catch
    fprintf('  Note: Could not save PDF (requires vector graphics support)\n');
end
fprintf('  Saved: diagnostics/analysis/effect_size_vs_accuracy.png\n');
...
% Save
saveas(fig2, 'diagnostics/analysis/effect_size_vs_accuracy_combined.png');
try
    saveas(fig2, 'diagnostics/analysis/effect_size_vs_accuracy_combined.pdf');
catch
end
fprintf('  Saved: diagnostics/analysis/effect_size_vs_accuracy_combined.png\n');
...
% Save
saveas(fig3, 'diagnostics/analysis/effect_size_per_subject.png');
try
    saveas(fig3, 'diagnostics/analysis/effect_size_per_subject.pdf');
catch
end
fprintf('  Saved: diagnostics/analysis/effect_size_per_subject.png\n');
