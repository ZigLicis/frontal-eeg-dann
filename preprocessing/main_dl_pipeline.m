...
fprintf('Data exported for %d folds to outputs/python_data/ directory\n', k_folds);
fprintf('\nNext steps:\n');
fprintf('Run: python training/dann.py --data_dir outputs/python_data\n');

% Save export completion flag
save(fullfile(fileparts(pwd), 'outputs', 'python_data', 'export_complete.mat'), 'k_folds', 'unique_subjects');
