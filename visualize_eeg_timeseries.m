...
%   >> visualize_eeg_timeseries(EEG, 'After ICA', [], [], 'diagnostics/viz/after_ica.png');  % Entire recording, saved
%   >> visualize_eeg_timeseries(EEG, 'After ICA', 30, 10, 'diagnostics/viz/after_ica.png');  % 10 sec starting at 30 sec
%
% Inputs:
